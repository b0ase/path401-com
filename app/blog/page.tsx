...
const posts = [
  ...
  },
  {
    ...
    href: 'https://b0ase.com/blog/401-identity-token-peers-underwrite',
    date: '2026-02-09',
    tag: 'identity',
  },
  {
  ...
  },
  {
    ...
    href: 'https://b0ase.com/blog/micro-capital-micro-speculation-economy',
    date: '2026-02-09',
    tag: 'micro-capital',
  },
  {
    title: "Micro Capital: The World's Smallest Hedge Fund",
    description: "How one founder is proving that hedge funds don't need billions to be brilliant.",
    href: 'https://b0ase.com/blog/micro-capital-worlds-smallest-hedge-fund',
    date: '2026-02-09',
    tag: 'micro-capital',
  },
];
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-[8px] font-mono text-violet-500 uppercase tracking-widest">{post.tag}</span>
