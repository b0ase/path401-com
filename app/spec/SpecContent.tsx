        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-4 font-display">
              $401<span className="text-zinc-300 dark:text-zinc-700">.SPEC</span>
            </h1>
          </div>
          ...
          <article
            className="prose prose-zinc dark:prose-invert prose-sm max-w-none
              ...
              prose-code:text-violet-500 prose-code:bg-zinc-100 dark:prose-code:bg-zinc-900 prose-code:px-1 prose-code:py-0.5 prose-code:text-xs prose-code:font-mono
